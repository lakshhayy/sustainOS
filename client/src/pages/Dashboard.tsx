...
import { AlertTriangle, TrendingUp, TrendingDown, Leaf, Droplets, Activity, BarChart3 } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 2. TABS: Digital Twin vs Analytics */}
      <Tabs defaultValue="twin" className="w-full">
        ...
        {/* TAB 1: THE MAP */}
        <TabsContent value="twin" className="mt-4 animate-in fade-in-50 duration-500">
          <DigitalTwin />
        </TabsContent>

        {/* TAB 2: THE CHARTS */}
        <TabsContent value="analytics" className="mt-4 space-y-4 animate-in fade-in-50 duration-500">
            {/* Warning Alert */}
            {isPeakWarning && (
                ...
                <AlertDescription className="text-amber-700 dark:text-amber-400">
                    Predicted energy usage for tomorrow exceeds the 1000 kWh threshold. Consider enabling demand response protocols.
                </AlertDescription>
                </Alert>
            )}
            ...
            <Card className="shadow-sm border-border/60 overflow-hidden">
                ...
                <CardDescription>Aggregate campus usage (Actual vs Predicted)</CardDescription>
                </CardHeader>
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    <Area type="monotone" dataKey="predictedEnergy" name="Predicted" stroke="hsl(var(--chart-2))" strokeWidth={2} strokeDasharray="5 5" fill="url(#colorPredicted)" />
                    <Area type="monotone" dataKey="actualEnergy" name="Actual" stroke="hsl(var(--primary))" strokeWidth={3} fill="url(#colorActual)" />
                    </AreaChart>
                </ResponsiveContainer>
                </CardContent>
            </Card>
